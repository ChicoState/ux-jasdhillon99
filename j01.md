...
## Step 1: Home
<img src="assets/1_home.PNG" alt="Home" length="25%" width="50%"> <br />

We start on the home screen where the User’s **Coneptual Model** is born from the circles we see under the Energy Summary. We can infer the app works by adding up all our food and see how much of this pie we have left.
